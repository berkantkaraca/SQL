...
--FORALL ve BULK COLLECT beraber kullan?m?
--state de?eri CT olan kay?tlar BULK COLLECT ile al?n?yor
--FORALL ile my_zipcode tablosuna aktar?l?yor
DECLARE
  -- Declare collection types
TYPE string_type
IS
...
/*
B) Modify the newly created script as follows: Fetch no more than five rows at a time from the
MY_INSTRUCTOR table.
*/
...
/*
C) Modify the newly created script as follows: Instead of fetching data from the MY_INSTRUCTOR
table into individual collections, fetch it into a single collection.
*/
...
/*
D) Create the following script:Delete records from the MY_INSTRUCTOR table and display them on
the screen.
*/
