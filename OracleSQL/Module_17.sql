...
--11106 nolu zipe sahip bütün öğrencileri tutan yeni bir tablo oluşturuluyor
--kaç öğrenci eklendiği bilgisi değişkene aktarılıp ekranda gösteriliyor
--günün tarihini gösteren PL/SQL blok oluşturulup ekrana yazdırılıyor
-- son olarak 151 nolu öğrencinin zip değeri 11105 olarak değiştiriliyor
DECLARE
...
--hatal? hali
--DDL c�mleleri i�inde bind variable kullan?lamaz!!!
DECLARE
  sql_stmt         VARCHAR2(100);
  v_zip            VARCHAR2(5) := '11106';
  v_total_students NUMBER;
...
--SQL c�mleleri ; ile PL/SQL bloklar? / ile bitemez!!!
...
--D�zeltilmi? hali. Null bir de?i?ken atan?yor
DECLARE
  sql_stmt VARCHAR2(100);
  v_null   VARCHAR2(1);
BEGIN
...
--girilen �?rencinin ad? ve soyad? bilgisi ekranda g�sterilsin
...
--de?i?kenlerin s?ras? �nemli �stteki i�in denenebilir
...
--Ayn? �rnek tek tek variable tan?mlanarak de?il, record tan?mlanarak yaz?l?yor
